...
### Ближайший план на 2 недели (фокус на разработке тестов)

**Цель:** Максимально быстро увеличить тестовое покрытие и стабилизировать процесс. В ближайшие две недели мы концентрируемся исключительно на написании тестов, отложив все остальные задачи по развитию фреймворка.

**Неделя 1: Завершение Unit-тестов и стабилизация отчетности**

*   **Основная задача:** Добиться 100% выполнения плана по Unit-тестам из "Этапа 2".
...
*   **Второстепенная задача:** Убедиться, что история (trends) в Allure-отчетах работает стабильно в CI. Провести рефакторинг существующих тестов для улучшения читаемости.

**Неделя 2: Внедрение базовых UI-тестов**

*   **Основная задача:** Реализовать 2-3 ключевых E2E-сценария.
    *   [ ] Настроить таргет для UI-тестов и создать базовый тестовый класс.
    *   [ ] Реализовать Page Objects для основных экранов (Login, Catalog, Cart).
    *   [ ] Написать UI-тесты на ключевые пользовательские сценарии (например, авторизация, добавление товара в корзину, проверка корзины).
    *   [ ] Интегрировать запуск UI-тестов в CI-пайплайн.
...
## Этап 2: Разработка Unit-тестов и улучшение отчетности (19.10 - 24.10)

**Цель:** Покрыть ключевую бизнес-логику приложения unit-тестами и настроить качественную отчетность с историей запусков.
...
* [ ] **Портфолио (`swift-ios-test-demo`):**
  ...
  * [ ] **Настройка отчетности:**
    * [x] Интегрировать Jekyll для создания кастомной страницы отчетов на GitHub Pages.
    * [x] Улучшить отчет SwiftLint: добавить стилизацию, копирование путей и интерактивную фильтрацию.
    * [x] Настроить единую точку входа для всех отчетов (Allure, SwiftLint, SwiftFormat, Code Coverage).
    * [x] Улучшена интеграция Allure, обеспечено сохранение истории запусков (trends).
  * [x] **Документация по Allure 3:**
    * [x] Созданы и обновлены уроки по Allure 3 (01-08), включая описание конфигурационного файла.
    * [x] Создан полный справочник по всем командам CLI (`allure`, `generate`, `open`, `history` и др.).
    * [x] Созданы руководства по интеграции с GitHub Actions, Jenkins, GitLab.
    * [x] Добавлен разбор комплексного CI-пайплайна для XCTest и Allure.
  * [x] **Планирование:**
...
## Этап 3: Реализация базовых UI-тестов и Page Objects (25.10 - 28.10)
...
## Этап 4: Внедрение Snapshot-тестирования (29.10 - 30.10)
...
## Этап 5: Настройка GitLab CI (31.10 - 01.11)
...
## Этап 6: Создание слоя абстракций (02.11 - 03.11)
...
## Этап 7: Реализация хелперов и сервисов (04.11)
...
## Этап 8: Интеграция с облачными сервисами (05.11)
...
## Этап 9: Финальный рефакторинг и документация (06.11)
